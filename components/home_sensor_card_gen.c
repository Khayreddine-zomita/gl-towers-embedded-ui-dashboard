...
lv_obj_t * home_sensor_card_create(lv_obj_t * parent, const char * sensor_title, const char * sensor_value, const char * sensor_unit, int32_t sensor_unit_x, const char * sensor_status, lv_color_t sensor_title_color, lv_color_t sensor_status_color)
{
    ...
    lv_obj_set_x(home_sensor_title, 12);
    lv_obj_set_y(home_sensor_title, 6);
    lv_obj_set_width(home_sensor_title, 120);
    ...
    lv_obj_set_x(home_sensor_value, 12);
    lv_obj_set_y(home_sensor_value, 23);
    lv_obj_set_width(home_sensor_value, 80);
    ...
    lv_obj_set_y(home_sensor_unit, 35);
    lv_obj_set_width(home_sensor_unit, 34);
    ...
    lv_obj_set_style_text_font(home_sensor_unit, font_inter_12, 0);

    lv_obj_t * home_sensor_status = lv_label_create(lv_obj_0);
    lv_obj_set_name(home_sensor_status, "home_sensor_status");
    lv_obj_set_x(home_sensor_status, 158);
    lv_obj_set_y(home_sensor_status, 33);
    lv_obj_set_width(home_sensor_status, 58);
    lv_label_set_text(home_sensor_status, sensor_status);
    lv_label_set_long_mode(home_sensor_status, LV_LABEL_LONG_MODE_CLIP);
    lv_obj_set_style_text_align(home_sensor_status, LV_TEXT_ALIGN_RIGHT, 0);
    lv_obj_set_style_text_color(home_sensor_status, sensor_status_color, 0);
    lv_obj_set_style_text_font(home_sensor_status, font_inter_12, 0);
