...
lv_obj_t * home_reservoir_card_create(lv_obj_t * parent, const char * reservoir_value, int32_t reservoir_unit_x, const char * reservoir_volume, const char * reservoir_hint, int32_t reservoir_level)
{
    ...
    lv_obj_set_x(reservoir_title_label, 12);
    lv_obj_set_y(reservoir_title_label, 12);
    lv_obj_set_width(reservoir_title_label, 92);
    ...
    lv_obj_set_x(reservoir_water_icon, 110);
    lv_obj_set_y(reservoir_water_icon, 30);
    lv_obj_set_width(reservoir_water_icon, 26);
    lv_obj_set_height(reservoir_water_icon, 26);
    ...
    lv_obj_set_x(reservoir_percent_label, 12);
    lv_obj_set_y(reservoir_percent_label, 48);
    lv_obj_set_width(reservoir_percent_label, 78);
    ...
    lv_obj_set_y(reservoir_percent_unit_label, 61);
    ...
    lv_obj_set_x(reservoir_volume_label, 12);
    lv_obj_set_y(reservoir_volume_label, 92);
    lv_obj_set_width(reservoir_volume_label, 126);
    ...
    lv_obj_set_x(reservoir_hint_label, 12);
    lv_obj_set_y(reservoir_hint_label, 110);
    lv_obj_set_width(reservoir_hint_label, 126);
    ...
    lv_obj_set_style_text_font(reservoir_hint_label, font_inter_10, 0);

    lv_obj_t * reservoir_level_bar = lv_bar_create(lv_obj_0);
    lv_obj_set_name(reservoir_level_bar, "reservoir_level_bar");
    lv_obj_set_x(reservoir_level_bar, 12);
    lv_obj_set_y(reservoir_level_bar, 132);
    lv_obj_set_width(reservoir_level_bar, 126);
