...
lv_obj_t * led_edit_settings_button_card_create(lv_obj_t * parent, const char * button_text)
{
    ...
    lv_obj_set_x(led_edit_settings_btn, 12);
    lv_obj_set_y(led_edit_settings_btn, 8);
    lv_obj_set_width(led_edit_settings_btn, 440);
    lv_obj_set_height(led_edit_settings_btn, 32);
    ...
    lv_obj_set_y(led_edit_settings_label, 6);
