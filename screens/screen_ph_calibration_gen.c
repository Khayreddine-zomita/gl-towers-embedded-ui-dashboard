...
lv_obj_t * screen_ph_calibration_create(void)
{
    ...
    lv_obj_t * ph_calibration_card_0 = ph_calibration_card_create(lv_obj_0, "Step 1/3", "6.98", "Stable", "Place probe in buffer", "Rinse the probe, place it in pH 7.00 buffer, then wait until the reading becomes stable.");
    lv_obj_set_x(ph_calibration_card_0, 14);
    lv_obj_set_y(ph_calibration_card_0, 52);

    lv_obj_t * ph_calibration_bottom_actions_0 = ph_calibration_bottom_actions_create(lv_obj_0, "Cancel", "Save Point");
    lv_obj_set_x(ph_calibration_bottom_actions_0, 14);
    lv_obj_set_y(ph_calibration_bottom_actions_0, 275);
