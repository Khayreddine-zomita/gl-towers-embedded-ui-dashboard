...
lv_obj_t * screen_irrigation_create(void)
{
    ...
    lv_obj_t * global_bottom_nav_0 = global_bottom_nav_create(lv_obj_0, COLOR_DARK_FOREST, COLOR_DARK_FOREST, COLOR_STATUS_HEALTHY, COLOR_DARK_FOREST, COLOR_DARK_FOREST);
