...
lv_obj_t * screen_ec_calibration_create(void)
{
    ...
    lv_obj_t * ec_calibration_card_0 = ec_calibration_card_create(lv_obj_0, "Step 1/2", "1.41", "Stable", "Place probe in EC solution", "Rinse the probe, select the EC solution, then wait until the reading becomes stable.");
    lv_obj_set_x(ec_calibration_card_0, 14);
    lv_obj_set_y(ec_calibration_card_0, 52);

    lv_obj_t * ec_calibration_bottom_actions_0 = ec_calibration_bottom_actions_create(lv_obj_0, "Cancel", "Save Point");
    lv_obj_set_x(ec_calibration_bottom_actions_0, 14);
    lv_obj_set_y(ec_calibration_bottom_actions_0, 275);
