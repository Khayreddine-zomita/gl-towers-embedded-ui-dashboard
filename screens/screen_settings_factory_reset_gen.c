...
lv_obj_t * screen_settings_factory_reset_create(void)
{
    ...
    lv_obj_t * settings_factory_reset_card_0 = settings_factory_reset_card_create(lv_obj_0, "Protected");
    lv_obj_set_x(settings_factory_reset_card_0, 14);
    lv_obj_set_y(settings_factory_reset_card_0, 52);

    lv_obj_t * settings_factory_reset_bottom_actions_0 = settings_factory_reset_bottom_actions_create(lv_obj_0, "Back", "Reset Device");
    lv_obj_set_x(settings_factory_reset_bottom_actions_0, 14);
    lv_obj_set_y(settings_factory_reset_bottom_actions_0, 275);
