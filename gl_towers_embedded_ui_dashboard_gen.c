...
const void * img_settings_account;
extern const void * img_settings_account_data;
const void * img_settings_wlan;
extern const void * img_settings_wlan_data;
const void * img_settings_device;
extern const void * img_settings_device_data;
const void * img_settings_calibration;
extern const void * img_settings_calibration_data;
const void * img_settings_firmware;
extern const void * img_settings_firmware_data;
const void * img_settings_language;
extern const void * img_settings_language_data;
const void * img_settings_terms_of_use;
extern const void * img_settings_terms_of_use_data;
const void * img_settings_factory_reset;
extern const void * img_settings_factory_reset_data;
const void * img_settings_system_status;
extern const void * img_settings_system_status_data;
const void * img_settings_last_update;
extern const void * img_settings_last_update_data;
...
void gl_towers_embedded_ui_dashboard_init_gen(const char * asset_path)
{
    ...
    img_settings_account = &img_settings_account_data;
    img_settings_wlan = &img_settings_wlan_data;
    img_settings_device = &img_settings_device_data;
    img_settings_calibration = &img_settings_calibration_data;
    img_settings_firmware = &img_settings_firmware_data;
    img_settings_language = &img_settings_language_data;
    img_settings_terms_of_use = &img_settings_terms_of_use_data;
    img_settings_factory_reset = &img_settings_factory_reset_data;
    img_settings_system_status = &img_settings_system_status_data;
    img_settings_last_update = &img_settings_last_update_data;
    ...
    lv_xml_register_image(NULL, "img_settings_account", img_settings_account);
    lv_xml_register_image(NULL, "img_settings_wlan", img_settings_wlan);
    lv_xml_register_image(NULL, "img_settings_device", img_settings_device);
    lv_xml_register_image(NULL, "img_settings_calibration", img_settings_calibration);
    lv_xml_register_image(NULL, "img_settings_firmware", img_settings_firmware);
    lv_xml_register_image(NULL, "img_settings_language", img_settings_language);
    lv_xml_register_image(NULL, "img_settings_terms_of_use", img_settings_terms_of_use);
    lv_xml_register_image(NULL, "img_settings_factory_reset", img_settings_factory_reset);
    lv_xml_register_image(NULL, "img_settings_system_status", img_settings_system_status);
    lv_xml_register_image(NULL, "img_settings_last_update", img_settings_last_update);
